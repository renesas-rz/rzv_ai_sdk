...
/*****************************************
* Static Variables for classification model
...
******************************************/
/* Model Binary */
const static std::string model_dir = "fish_classification_model";
/* Class labels to be classified */
const static std::string label_list     = "fish_class_list.txt";
