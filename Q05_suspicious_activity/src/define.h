...
/* Model Binary */
#ifdef V2H
    const static std::string cnn_model_dir = "cnn_module";
    const static std::string mlp_model_dir = "mlp_module";
#elif V2L
    const static std::string model_dir = "combined_module";
#endif
...
#define DRPAI_MEM_OFFSET            (0x1000000)
...
#elif V2L
    /*Image display out*/
    #define DISP_IMAGE_OUTPUT_WIDTH     (930)
