...
* Description   : Function to compute the area of intersection of BBox a and b
* Arguments     : a = BBox 1
*                 b = BBox 2
...
* Description   : Function to compute the area of union of BBox a and b
* Arguments     : a = BBox 1
*                 b = BBox 2
...
* Description   : Function to compute the Intersection over Union (IoU) of BBox a and b
* Arguments     : a = BBox 1
*                 b = BBox 2
* Return value  : IoU
******************************************/
