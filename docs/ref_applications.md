...
<div class="container">
    <div class="row">
        ...
        <div id="ref5" class="application_card col-lg-6 col-xl-4">
            <li class="griditem" style="list-style: none;">
                <img src="img/ref_app/renesas_stereoai_960x540.jpg" alt="application">
                <dt class="mt-1" style="color: #2a289d;">Object Detection and Distance Measurement</dt>
                <h6 class="appstatus" align="right"><b><br /></b></h6>
                <div class="griditem-add">
                    This sample application combines YOLOv8-seg and StereoSGM to perform object detection, segmentation, and distance measurement simultaneously. By leveraging segmentation masks generated by YOLOv8-seg together with stereo disparity data from StereoSGM, it enables fast and accurate distance estimation for each detected object. A <a href="https://github.com/renesas-rz/rzv_sample_apps/tree/main/S03_stereosgm">standalone StereoSGM sample application</a> is also available.
                    <br><br>
                </div>
                <dl>
                    <dd style="display: flex">
                        <div class="partnerlinkbutton_parent">
                            <a class="partnerlinkbutton" 
                                href="https://github.com/renesas-rz/rzv_sample_apps/tree/main/S04_app_yolov8_seg_stereo_cam" 
                                style="color:white"
                                target="_blank" rel="noopener noreferrer">
                                Click >
                            </a>
