...
<!--          <div class="note">
            ...
            Please use source code and object files for RZ/V2H, and follow the steps <a href="https://github.com/renesas-rz/rzv_ai_sdk/tree/v6.20/R01_object_detection#application-build-stage" target="_blank" rel="noopener noreferrer">Application: Build Stage</a> to build the application in the RZ/V2N AI SDK environment.
          </div> -->
          <div class="box1">
            <u><b>Example:</b></u><br>
