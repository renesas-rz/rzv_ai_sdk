...
<div class="applications">
    <p class=" column small-12 medium-6 large-3>
        <img src="img/HeadCount.png" alt="head_count" width=180px/>
        <ul class="applications">
        <li><a href="https://github.com/Ignitarium-Renesas/RZV2L_AiLibrary/tree/main/01_Head_count"><strong>Head Count</strong></a></li>
        </ul>
    </p>
    <p class=" column small-12 medium-6 large-3>
    <img src="img/HelmetDetection.png" alt="helmet_detection" width=180px/>
    <ul class="applications">
    <li><a href="https://github.com/Ignitarium-Renesas/RZV2L_AiLibrary/tree/main/01_Head_count"><strong>Helmet Detection</strong></a></li>
    </ul>
    </p>
</div> -->
