...
{% endhighlight %}
        ...
        <div class="note">
          ...
          To download the files of AI Applications v{{ site.version }}, please specify the version tag by adding <code>-b v7.10</code> when you running the <code>git clone</code> command as shown below.
{% highlight shell%}
git clone -b v7.10 https://github.com/Ignitarium-Renesas/RZV2L_AiLibrary
{% endhighlight %}
        </div>
        <!-- Until here: Delete when making latest version -->
      </li><br>
