...
<div class="ContentsTLT">
  ...
  <div class="note">
    <span class="note-title">Note</span>
    Refer to <a href="{{ site.url }}{{ site.baseurl }}{% link howto_retrain.md %}" target="_blank">How to Re-train AI model</a> for supported AI applications and usage of RZ/V AI TLT.  <br>
    This section just explains launching RZ/V AI TLT from AI Navigator.
  </div>
  <br>
  <h5 id="ainavi_option1-1">1. Configure the environment for RZ/V AI TLT</h5>
  <div class="note">
    <span class="note-title">Note</span>
    This step is required only during the initial installation or when updating RZ/V AI TLT.<br>
  ...
  <div class="container">
    <div class="row">
      <div class="col-6">
        (1) In the AI Navigator menu, click <b>"Transfer Learning"</b> to open the "Train AI" view.<br>
  ...
  <div class="container">
    <div class="row">
      <div class="col-6">
        (2) A confirmation window will appear, informing you that the installation may take some time. Click <b>"OK"</b> to proceed if you agree.<br>
        <br>
      </div>
      <div class="col-6">
        <a href="img/ainavi/ainavi_tlt_step1-2.png" data-lightbox="ainavi_tlt_step1-2"><img src="img/ainavi/ainavi_tlt_step1-2.png" alt="ainavi TLT install 2" width="80%" /></a>
      </div>
    </div>
  </div>
  <br>
  <div class="container">
    <div class="row">
      <div class="col-6">
        (3)  An installation check window will appear. Confirm each item, and click <b>"OK"</b> if everything is acceptable.
        <br>
      </div>
      <div class="col-6">
        <a href="img/ainavi/ainavi_tlt_step1-3.png" data-lightbox="ainavi_tlt_step1-3"><img src="img/ainavi/ainavi_tlt_step1-3.png" alt="ainavi TLT install 3" width="80%" /></a>
      </div>
    </div>
  </div>
  <br>
  <div class="container">
    <div class="row">
      <div class="col-6">
        (4) The Renesas download page will open automatically.<br>
        Please read the "SOFTWARE LICENSE AGREEMENT" carefully, and click "Accept and download" to begin the download. <br>
        <br>
        <div class="note">
          <span class="note-title">Note</span>
          Downloading RZ/V AI TLT may take some time.
        </div>
      </div>
      <div class="col-6">
        <a href="img/ainavi/ainavi_tlt_step1-4.png" data-lightbox="ainavi_tlt_step1-4"><img src="img/ainavi/ainavi_tlt_step1-4.png" alt="ainavi TLT install 4" width="80%" /></a>
      </div>
    </div>
  </div>
  <div class="container">
    <div class="row">
      <div class="col-6">
        (5) Once the download is complete, select the RZ/V AI TLT archive file you downloaded.<br>
      </div>
      <div class="col-6">
        <a href="img/ainavi/ainavi_tlt_step1-5.png" data-lightbox="ainavi_tlt_step1-5"><img src="img/ainavi/ainavi_tlt_step1-5.png" alt="ainavi TLT install 5" width="80%" /></a>
      </div>
    </div>
  </div>
  <br>
  <div class="container">
    <div class="row">
      <div class="col-6">
        (6)  During setup, a window will appear prompting you to enter your root password. Enter the password to continue the installation.<br>
      <br>
      </div>
      <div class="col-6">
        <a href="img/ainavi/ainavi_tlt_step1-6.png" data-lightbox="ainavi_tlt_step1-6"><img src="img/ainavi/ainavi_tlt_step1-6.png" alt="ainavi TLT install 6" width="80%" /></a>
      </div>
    </div>
  </div>
  <br>
  <div class="container">
    <div class="row">
      <div class="col-6">
        (7) When the setup is complete, the installation window will close automatically.<br>
        At this point, check the console in e<sup>2</sup> studio. If the log matches the image below, the setup was successful. <br>
        <br>
      </div>
      <div class="col-6">
{% highlight shell %}
...
{% endhighlight %}
  ...
  <div class="container">
    <div class="row">
      <div class="col-6">
        (1) Click <b>"Transfer Learning..."</b>.<br>
      </div>
      <div class="col-6">
        <a href="img/ainavi/ainavi_tlt_step2-1.png" data-lightbox="ainavi_tlt_step2-1"><img src="img/ainavi/ainavi_tlt_step2-1.png" alt="ainavi TLT launch 1" width="80%" /></a>
      </div>
    </div>
  </div>
  <br>
  <div class="container">
    <div class="row">
      <div class="col-6">
        (2) Select your target TLT project.<br>
      </div>
      <div class="col-6">
        <a href="img/ainavi/ainavi_tlt_step2-2.png" data-lightbox="ainavi_tlt_step2-2"><img src="img/ainavi/ainavi_tlt_step2-2.png" alt="ainavi TLT launch 2" width="80%" /></a>
      </div>
    </div>
  </div>
  <br>
  <div class="container">
    <div class="row">
      <div class="col-6">
        (3) To open the web guide (<a href="{{ site.url }}{{ site.baseurl }}{% link howto_retrain.md %}" target="_blank">How to Re-train AI model</a>), select <b>"Yes"</b>. Otherwise, select "no".<br>
      </div>
      <div class="col-6">
        <a href="img/ainavi/ainavi_tlt_step2-3.png" data-lightbox="ainavi_tlt_step2-3"><img src="img/ainavi/ainavi_tlt_step2-3.png" alt="ainavi TLT launch 3" width="80%" /></a>
      </div>
    </div>
  </div>
  <br>
  <div class="container">
    <div class="row">
      <div class="col-6">
        (4) RZ/V AI TLT will launch. You can now start training the AI model.<br>
      </div>
      <div class="col-6">
        <a href="img/ainavi/ainavi_tlt_step2-4.png" data-lightbox="ainavi_tlt_step2-4"><img src="img/ainavi/ainavi_tlt_step2-4.png" alt="ainavi TLT launch 4" width="80%" /></a>
      </div>
    </div>
  </div>
  <br>
