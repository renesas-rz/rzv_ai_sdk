      ...
      <table class="gstable ms-4">
        ...
        <tr>
          ...
          <td>
            ...
            <br>
            <a class="btn btn-secondary square-button-gray ms-3 mt-1" style="text-align:left;" href="" role="button">
              <span class="banner-title">How to Build RZ/V2H AI SDK (Link not available)</span>
              <span class="banner-line">
...
<div class="container">
  <div class="row">
    <div class="col-12">
      ...
      <a class="btn btn-secondary square-button ms-3 mt-1" style="text-align:left;" href="" role="button">
        <span class="banner-title">Board and Software  (Link not available)</span>
      ...
      <a class="btn btn-secondary square-button ms-3 mt-1" style="text-align:left;" href="" role="button">
        <span class="banner-title">RZ/V2L EVK Getting Started  (Link not available)</span>
        <span class="banner-line">
        What is included in EVK?
        </span>
      </a>
      <br>
      <a class="btn btn-secondary square-button ms-3 mt-1" style="text-align:left;" href="{{ site.url }}{{ site.baseurl }}{% link getting_started_v2h_internal.md %}" role="button">
...
<reference2 class="forV2LDemo">
  ...
  <table>
    ...
    <tr>
      <td>microSD card</td>
      <td>Must have over 4GB capacity of blank space.<br>Operating Environment: Transcend UHS-I microSD 300S 16GB</td>
    </tr>
    <tr>
      <td>Linux PC</td>
...
<br>
To see the overview about AI Applications, please refer to <a href="">About AI Applications (Link not available)</a> page.<br>
<a class="btn btn-secondary square-button ms-3 mt-1" style="text-align:left;" href="" role="button">
    <span class="banner-title">About AI Applications (Link not available)</span><br>
    <span class="banner-line">
...
<a class="btn btn-secondary square-button ms-3 mt-1" style="text-align:left;" href="" role="button">
  <span class="banner-title">RZ/V2L EVK Getting Started Step 7 (Link not available)</span>
  <span class="banner-line">
...
<br>
<a class="btn btn-secondary square-button ms-3 mt-1" style="text-align:left;" href="{{ site.url }}{{ site.baseurl }}{% link getting_started_v2h_internal.md %}#step7" role="button">
...
<a class="btn btn-secondary square-button ms-3 mt-1" style="text-align:left;" href="" role="button">
  <span class="banner-title">RZ/V2L EVK Getting Started Step 8 (Link not available)</span>
  <span class="banner-line">
...
<br>
<a class="btn btn-secondary square-button ms-3 mt-1" style="text-align:left;" href="{{ site.url }}{{ site.baseurl }}{% link getting_started_v2h_internal.md %}#step8" role="button">
...
<div class="note">
  ...
  <ul>
    <li>
      <a href="{{ site.url }}{{ site.baseurl }}{% link appendix_internal.md %}#A3">A3. Shutdown RZ/V2L EVK</a>
    </li>
    <li>
      <a href="{{ site.url }}{{ site.baseurl }}{% link appendix_internal.md %}#A4">A4. Shutdown RZ/V2H EVK</a>
    </li>
  </ul>
</div>
<br><br>
