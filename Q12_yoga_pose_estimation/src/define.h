...
******************************************/
/* Model Binary */
const static std::string keypoint_model_dir = "keypoint_detection_model";
const static std::string pose_classifier_model_dir = "pose_classifier_model";
/* Label list file*/
const static std::string labels = "labels.txt";
...
#define YELLOW  cv::Scalar(33, 222,255)
#define GREEN   cv::Scalar(0, 230, 115)
...
#define DRPAI_MEM_OFFSET            (0x3000000)
...
/*Image display out*/
#define DISP_IMAGE_OUTPUT_WIDTH     (1440)
