...
2. Run the application.
    ...
    ```
>**Note:** For RZ/V2N AI SDK v6.00 and later or RZ/V2H AI SDK v6.00 and later or RZ/V2L AI SDK v7.00 and later, you need to switch to the root user with the 'su' command when running an application.<br>
